...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (empty($username_err) && empty($password_err)) {
        ...
        $sql = "SELECT agent_prs_code, agent_email, agent_password FROM agent WHERE agent_email = ?";
...
<body class="bg-gradient-primary">
                    ...
                    <div class="card-body p-0">
                        <div class="row">
                            <div class="col-lg-6 d-none d-lg-flex">
                                <div class="flex-grow-1 bg-login-image" style="background-image: url(assets/img/Photo_by_Naomi_Hébert_on_Unsplash.jpeg);"></div>
                            </div>
                            <div class="col-lg-6">
                                <div class="p-5">
    ...
    <div class="alert alert-info alert-dismissible h6 fade show fixed-bottom" role="alert">
        <p>
            We use cookies on this website to distinguish you from other users.<br>
            We use this data to enhance your experience.<br>
