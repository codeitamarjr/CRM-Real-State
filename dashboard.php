        ...
        <nav class="navbar navbar-dark align-items-start sidebar sidebar-dark accordion bg-gradient-primary p-0">
            <div class="container-fluid d-flex flex-column p-0">
                ...
                <ul class="navbar-nav text-light" id="accordionSidebar">
                    ...
                    <?php }; if (userACL('tenantsLedger') > 0) { ?>
                    <li class="nav-item"><a class="nav-link <?php if ($content == 'tenantsLedger') {
                                                                echo 'active';
                                                            } ?>" href="dashboard.php?access=tenantsLedger"><i class="bi bi-person-lines-fill" style="font-size: 20px;"></i><span>Tenants Ledger</span></a>
                    </li>
