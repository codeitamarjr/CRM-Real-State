...
<head>
    ...
    <title><?php if(isset($_GET['access'])) echo (ucfirst($_GET['access'])); else echo 'Dashboard'; ?> | <?php echo getPropertyData($_SESSION["property_code"], 'property_name'); ?> - Real Enquiries</title>
