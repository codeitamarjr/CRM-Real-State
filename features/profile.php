...
if (isset($_POST['upload'])) {
    ...
    userSetData($_SESSION["username"], 'agent_pic', $fileNameNew);
    echo '
                </center></div>
            </div>
        </div>
            ...
            <div class="card mb-3">
                <div class="card-body text-center shadow" style="padding: 11px;"><img class="rounded-circle mb-3 mt-4" src="features/uploads/<?php echo htmlentities(userGetData($_SESSION["username"], 'agent_pic')); ?>" width="160" height="160">
                    ...
                    <form method="POST" enctype="multipart/form-data">
                        <input type="hidden" name="id" value="<?php echo userGetData($_SESSION["username"], 'agent_id'); ?>" />
                        <input type="hidden" name="category" value="userProfile" />
