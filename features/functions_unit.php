...
function createSingleUnit($prs_code, $property_code, $unit_customCode, $description, $floor, $unit_block, $unit_number, $postal_code, $bedrooms,$type,$date_available, $status, $carpark, $rental_price)
{
    require "config/config.php";
    ...
    if (!mysqli_stmt_prepare($stmt, $sql)) {
        ...
        mysqli_stmt_bind_param($stmt, "ssssssssssssss", $prs_code, $property_code, $unit_customCode, $description, $floor, $unit_block, $unit_number, $postal_code, $bedrooms,$type, $date_available,$status, $carpark, $rental_price);
